...
Se utilizo el sistema de información geográfico QGIS para el procesamiento de datos de OpenStreetMap y la descarga de imágenes de GSV. El código se encuentra en el archivo "[download_images_gsv.py](qgis/download_images_gsv.py)", este archivo debe ser ejecutado en QGIS de la siguiente manera:
